...
{
      12,     0,    -1,     3,     9,     7,    13,     8,    -1,     3,
       1,     7,    13,     8,    -1,     3,     9,     1,    13,     8,
      -1,     3,     9,     7,     1,     8,    -1,    14,    -1,    13,
      14,    -1,     4,     9,     5,    -1,     4,     9,     6,     1,
      -1,     4,     1,     5,    -1,     1,     9,     5,    -1
};
...
{
  "$end", "error", "$undefined", "ENUM", "CASE", "SEMICOLON", "COLON",
  "LBRACE", "RBRACE", "IDENTIFIER", "ERROR", "$accept", "enum_declaration",
  "enum_cases", "enum_case", 0
};
#endif
...
{
      19,    -1,    24,    25,    13,    -2,     1,     1,    12,    26,
       0,     2,    -2,     3,     9,    11,    23,    28,    21,    -2,
      -2,    -2,    -2,    -2,    -2,    -2,    -2,    30,    -2
};
...
{
       3,    17,     9,     9,     9,    10,    10,    10,     4,    18,
      19,    21,     9,    14,     7,    10,    10,    22,    16,    23,
       8,    20,     1,    20,     5,    20,    26,    27,    24,    13,
      15,    28,     6,    25,     0,    16
};
...
{
       0,     3,    12,     1,     9,     0,     7,     1,     7,     1,
       4,    13,    14,    13,     1,    13,     9,     1,     9,     8,
      14,     8,     8,     8,     5,     5,     5,     6,     1
};
